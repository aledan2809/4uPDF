...
const PAGE_URL = `${BASE_URL}/how-to-compress-pdf`;

export const metadata: Metadata = {
  title: "How to Compress PDF Files - Free PDF Compressor",
  description:
    "Reduce PDF file size online for free. Compress large PDFs while maintaining quality. Fast compression, no software installation required.",
  openGraph: {
    type: "article",
    url: PAGE_URL,
    title: "How to Compress PDF Files - Free PDF Compressor",
...
export default function HowToCompressPDFPage() {
  const page = getHowToPage("compress-pdf");

  if (!page) {
    notFound();
  }

  const toolSlug = "compress-pdf";
