                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-gray-900 border border-gray-800 rounded-lg shadow-xl py-2">
                    ...
                    {user.role === "superadmin" && (
                      <Link
                        href="/superadmin"
                        className="block px-4 py-2 text-sm text-amber-400 hover:text-amber-300 hover:bg-gray-800"
                        onClick={() => setUserMenuOpen(false)}
                      >
                        <svg className="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {user ? (
                <>
                  ...
                  {user.role === "superadmin" && (
                    <Link
                      href="/superadmin"
                      className="px-4 py-2 text-sm text-amber-400 hover:text-amber-300 text-center"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      SuperAdmin
                    </Link>
