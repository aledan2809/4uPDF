...
const faqs = [
  {
    ...
    answer:
      "Simply upload your Word document (.docx or .doc) and our tool will convert it to a PDF file while preserving formatting.",
  },
  {
    question: "Will my formatting be preserved?",
    answer:
      "Yes, we preserve text formatting, fonts, and basic layout. Complex elements like macros are not included in the PDF.",
  },
  {
    question: "Can I convert multiple Word files at once?",
    answer:
      "Currently, you can convert one file at a time. For batch conversion, consider our premium plan.",
  },
  {
    question: "What Word formats are supported?",
    answer:
      "We support both .docx (modern Word) and .doc (legacy Word) formats for conversion to PDF.",
  },
  {
...
const relatedTools = [
  { name: "PDF to Word", href: "/tools/pdf-to-word", description: "Convert PDF to Word document" },
...
export default function WordToPDFPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.detail || "Failed to convert Word document");
      }
  ...
  return (
    <ToolPageLayout
      title="Word to PDF"
      description="Convert Word documents (DOCX, DOC) to PDF format while preserving formatting and layout."
      faqs={faqs}
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-8">
        {!result ? (
            ...
            {!file ? (
              ...
              >
                ...
                <p className="text-lg text-white mb-2">
                  Drop your Word document here or <span className="text-blue-400">browse</span>
                </p>
                <p className="text-sm text-gray-500">Supports .docx and .doc files (Max 50MB)</p>
              </FileUploadZone>
            ) : (
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Document Converted Successfully!</h3>
            <p className="text-gray-400 mb-6">Your Word document has been converted to PDF</p>
