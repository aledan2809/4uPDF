...
const faqs = [
  {
    ...
    answer:
      "Simply upload your PDF file and our tool will convert it to an editable Word document (DOCX) while preserving the original formatting.",
  },
  {
    question: "Is the conversion accurate?",
    answer:
      "Our converter preserves text, images, and basic formatting. Complex layouts may require minor adjustments after conversion.",
  },
  {
    question: "Can I edit the Word document after conversion?",
    answer:
      "Yes! The converted DOCX file can be opened and edited in Microsoft Word, Google Docs, or any compatible word processor.",
  },
  {
    question: "What about scanned PDFs?",
    answer:
      "For scanned PDFs, we use OCR technology to extract text. Quality depends on the scan resolution and clarity.",
  },
  {
...
const relatedTools = [
  { name: "Word to PDF", href: "/tools/word-to-pdf", description: "Convert Word documents to PDF" },
...
export default function PDFToWordPage() {
  ...
  return (
    <ToolPageLayout
      title="PDF to Word"
      description="Convert PDF files to editable Word documents (DOCX) while preserving formatting and layout."
      faqs={faqs}
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-8">
        {!result ? (
            ...
            {isProcessing && (
              <div className="mt-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-400">Converting to Word...</span>
          ...
          <div className="text-center py-8">
            ...
            {result.pages && (
              <p className="text-gray-400 mb-2">Converted {result.pages} pages</p>
            )}
            {result.note && (
              <p className="text-yellow-400 text-sm mb-4">{result.note}</p>
            )}
