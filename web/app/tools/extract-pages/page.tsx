...
const faqs = [
  {
    ...
    answer:
      "Upload your PDF file, enter the page numbers you want to extract (e.g., '1,3,5' or '2-5'), and click Extract Pages. A new PDF containing only those pages will be created.",
  },
  {
    question: "Can I extract multiple page ranges?",
    answer:
      "Yes! You can specify individual pages (e.g., '1,3,5'), page ranges (e.g., '2-5'), or combinations (e.g., '1,3-5,8-10').",
  },
  {
    question: "Does extracting pages affect the original PDF?",
    answer:
      "No, the original file is never modified. Extraction creates a new PDF containing only the selected pages.",
  },
  {
    question: "Will extracted pages maintain their quality?",
    answer:
      "Yes, extracted pages maintain their original quality. We don't compress or modify the content.",
  },
  {
    question: "Can I extract pages to share specific sections?",
    answer:
      "Extracting pages is perfect for sharing specific sections of a document while keeping confidential pages private.",
  },
];
...
export default function ExtractPagesPage() {
  ...
  const [result, setResult] = useState<{ downloadUrl: string; filename: string; pagesExtracted: number } | null>(null);
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.detail || "Failed to extract pages");
      }
  ...
  return (
    <ToolPageLayout
      ...
      description="Extract specific pages from your PDF and save them as a new document. Keep only the pages you need."
      faqs={faqs}
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-8">
        {!result ? (
            ...
            {isProcessing && (
              <div className="mt-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-400">Extracting pages...</span>
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Pages Extracted Successfully!</h3>
            <p className="text-gray-400 mb-6">
              Extracted {result.pagesExtracted} page(s) to a new PDF.
            </p>
