...
const faqs = [
  {
    ...
    answer:
      "Upload your PDF file, select the rotation angle (90°, 180°, or 270°), choose which pages to rotate, and click Rotate. Your rotated PDF will be ready for download instantly.",
  },
  {
    question: "Can I rotate specific pages only?",
    answer:
      "Yes! You can rotate all pages or specify individual pages (e.g., '1,3,5') or page ranges (e.g., '1-5,8-10') to rotate.",
  },
  {
    question: "What rotation angles are supported?",
    answer:
      "You can rotate pages by 90° (clockwise), 180° (upside down), or 270° (counter-clockwise).",
  },
  {
    question: "Will rotating affect my PDF quality?",
    answer:
      "No, rotating pages with 4uPDF maintains the original quality of your document. We don't compress or modify the content.",
  },
  {
    question: "Is my rotated PDF secure?",
    answer:
      "All uploads are encrypted, and files are automatically deleted from our servers after 24 hours.",
  },
];
...
export default function RotatePDFPage() {
  ...
  const handleRotate = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.detail || "Failed to rotate PDF");
      }
  ...
  return (
    <ToolPageLayout
      title="Rotate PDF"
      description="Rotate PDF pages by 90, 180, or 270 degrees. Choose to rotate all pages or specific pages."
      faqs={faqs}
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-8">
        {!result ? (
            ...
            {isProcessing && (
              <div className="mt-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-400">Rotating PDF...</span>
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">PDF Rotated Successfully!</h3>
            <p className="text-gray-400 mb-6">Your PDF has been rotated by {rotation}°</p>
